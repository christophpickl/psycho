...
.Locating sound works due to the ears receiving signals at different times (just as with link:/introduction/ch7-vision/index.html[vision]'s "binocular disparity").
