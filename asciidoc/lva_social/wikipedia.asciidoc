...
* link:../phenomena/milgrams_experiment.html[Milgram experiment]
** Showing how far people would go (even kill), giving electrical shocks to another person, while obeying an authority.
* link:../phenomena/stanford_prison_experiment.html[Stanford prison experiment]
...
* link:../phenomena/bobo_doll.html[Bandura's Bobo doll]
