...
** The areas are (OCEAN):
... Openness to experience: Intellect, imagination (instead traditional, conventional).
...
... Agreeableness: Friendly, optimistic (instead critical, aggressive).
... Neuroticism: Emotional stability.
** See the link:../../resources/big5.html[dedicated wiki page] on the Big 5.
** Online tests:
