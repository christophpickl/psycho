...
link:../people/goldberg-html.html[Lewis Goldberg] might be the most prominent researcher in personality psychology. He improved upon link:../people/cattell-raymond.html[Raymond Cattell]'s 16 fundamental factors and used **factor analysis** to come up with 5 factors. The most outstanding aspects (next to its incredible high validity and reliability) of this theory are:
